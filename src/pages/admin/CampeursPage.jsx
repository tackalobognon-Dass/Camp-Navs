          ...
          <div style={{ background: '#fff', borderRadius: '20px 20px 0 0', width: '100%', maxWidth: 480, maxHeight: '90vh', overflowY: 'auto', padding: '20px 16px 32px' }}
            ...
            <div className="flex gap-3">
              <button onClick={() => supprimerCampeur(ficheOuverte.id)}
                style={{ padding: '12px 14px', borderRadius: 10, background: '#FCEBEB', color: '#A32D2D', border: '0.5px solid #F09595', fontSize: 13, fontWeight: 500, cursor: 'pointer' }}>
                Supprimer
              </button>
              <button onClick={() => envoyerWhatsApp(ficheOuverte, versements)}
                style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, background: '#25D366', color: '#fff', border: 'none', borderRadius: 10, padding: '12px', fontSize: 13, fontWeight: 500, cursor: 'pointer' }}>
              ...
              <button onClick={() => setFicheOuverte(null)}
                style={{ padding: '12px 14px', borderRadius: 10, background: '#085041', color: '#fff', border: 'none', fontSize: 13, fontWeight: 500, cursor: 'pointer' }}>
                Fermer
              </button>
            </div>
          </div>
